  ...
  return (
    <div className="min-h-screen bg-[var(--app-bg)] flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 pt-16 pb-8 max-w-sm mx-auto w-full text-center">
        <h2 className="text-[var(--app-text)] mb-6">What would you like to do?</h2>
        ...
        <button
          onClick={onExit}
          className="w-full bg-[var(--app-surface-alt)] hover:bg-[var(--app-elevated)] border border-[var(--app-border)] text-[var(--app-text-60)] py-4 rounded-xl transition-colors"
        >
          Exit
        </button>
      </div>
